...
#define PLL_PERIOD_NOMINAL      (1 << 20)
#define PLL_PERIOD_MIN          (PLL_PERIOD_NOMINAL - PLL_PERIOD_NOMINAL/2 - PLL_PERIOD_NOMINAL/4)
#define PLL_PERIOD_MAX          (PLL_PERIOD_NOMINAL + PLL_PERIOD_NOMINAL/2 + PLL_PERIOD_NOMINAL/4)

static uint32_t nco_v3(
...
static struct parameter nco_v3_params[] = {
...
struct algorithm algorithm_nco_v3 = {
    .name = "nco_v3",
    .func = nco_v3,
    .params = nco_v3_params,
};