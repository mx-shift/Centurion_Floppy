...
uint32_t nco_2160k_0p2(uint16_t write_bc_ticks, uint16_t *ff_samples, size_t ff_sample_count, uint32_t *bc_buf, uint32_t bc_bufmask, struct kv_pair *params)
{
    // dma_wr struct
    uint32_t phase_step;
...
struct algorithm algorithm_nco_2160k_0p2 = {
    .name = "nco_2160k_0p2",
    .func = nco_2160k_0p2,
    .params = NULL,
};